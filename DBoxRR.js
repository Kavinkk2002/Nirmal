...
function fCreateSearchRow(Tab){
        ...
        for(var i=0; i<tr1.cells.length;i++){
            ...
            x.innerHTML = "<input type=text  style='width:80%;border: 1px solid #54966d;' onkeyup=\"fSearchGridList(this,"+ i +");\" class='tSearches' ><img class='ss' src='S.png'"
