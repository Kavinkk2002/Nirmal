        ...
        strr += "<table border=0 class=MCalendar cellspacing=1 align=center width=100%>";
        strr += "<tr height=25px><td colspan=6 align=center _class=DContent style='cursor:hand'>CALENDER</td><td  class=CellHeader style='Cursor:hand;' align=center onclick='fnCloseDv();'>X</td></tr>";
            strr += "<tr height=20px><td colspan=7 align=center _class=DContent style='cursor:hand'><label id=yrback  style='Cusrsor:hand' _onclick='fnGDate(3)'>";
        ...
        //	strr += month_name[month_num];
            ...
            strr += "<tr _class=DFldHead><th>S</th><th>M</th><th>T</th><th>W</th>";
            strr += "<th>T</th><th>F</th><th>S</th></tr><tr _class=DFldHead>";
            first_day = new Date(right_year,month_num,1)
            for (counter = 0; counter < 7; counter++){ 
            if (counter >= first_day.getDay() ){
                theday=theday+1;
                if (theday == thedate)
                { strr += "<td id=td" + theday + "  onclick='fnDate(this);' _class='DContent' style='cursor:hand'><input type=text  style='width:0%;display:none;' onkeyup='fnfoc(this," + theday + ");'  onkeypress='fnGetDate(this,this.parentNode," + theday + ");' onblur='fngetOut(this);' onfocus='fnGetInn(this);' id=tDO" + theday + "><b>" + theday + "</b></td>"; }
                else
                { strr += "<td id=td" + theday + " onclick='fnDate(this);'  _class='DContent' style='cursor:hand'><input type=text  style='width:0%;display:none;' onkeyup='fnfoc(this," + theday + ");' id=tDO" + theday + "  onkeypress='fnGetDate(this,this.parentNode," + theday + ");'  onblur='fngetOut(this);' onfocus='fnGetInn(this);'>" + theday + "</td>"; }
            }
        else { strr += "<td _class='DContent'></td>"; }
        }
        strr += "</tr>";
        
        for (weeks = 0; weeks < 5; weeks++)
        {
            strr += "<tr style='height:25px;'>"; 
            ...
            { 
                ...
                { strr += "<td _class='DContent'>&nbsp;</td>"; }
                else
                { strr += "<td  _class='DContent' style='cursor:hand' id=td" + theday + " onclick='fnDate(this);'><input type=text width=0%  style='width:0%;display:none;' onkeyup='fnfoc(this," + theday + ");' onkeypress='fnGetDate(this,this.parentNode," + theday + ");' onblur='fngetOut(this);' onfocus='fnGetInn(this);' id=tDO" + theday + ">" + theday + "</td>"; }
            }
        }
            strr += "</tr>";
        }
        strr += "<tr align=center style='display:none;'><td colspan=5 _class='DContent'>&nbsp;</td><td onclick=fnGDate(1); style='cursor:hand' class=tdWhite>"
